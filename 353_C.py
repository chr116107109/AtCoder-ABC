...
for i in range(N-1):
    ...
    lower_mod_count = bit.count_lower(mod - A[i]-0.5)
    higher_mod_count = N - i - 1 - lower_mod_count
    #print(lower_mod_count,higher_mod_count)
    ans += _sum + A[i]*(N-i-1) - higher_mod_count*mod
